...
VARIANTS = [
    ("R1-fair210",    "nets/R1-fair210.net.xml",
     "RECOMMENDED (no construction) — 4 phases each fully protected, 210 s cycle"),
    ("3-delivered",   "../networks/balegere-no-uturn-traffic.net.xml",
     "As delivered — 4 phases each fully protected, 171 s cycle"),
...
if __name__ == "__main__":
    ...
    with open(os.path.join(OUT, "nobuild.html"), "w") as f:
